...
public class JP_TC04_QuoteWithDR extends Driver_Setup{
	...
	public void VSQuoteWithDR(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			Extent_Reporting.Log_Fail("Quote_With_DR Failed.",
					"Quote_With_DR Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
