...
public class JP_TC18_Submit_To_IBM_Special_Condition extends Driver_Setup {
	...
	public void JP_TC18_Submit_To_IBM_Special_Condition_main(String MySAURL, String IBMURL, String ENV)
			throws Throwable {
		try {
...
//			if (statusibm.contains("IBM approved")) {
				Extent_Reporting.Log_Pass("JP_TC18_Submit_To_IBM_Special_Condition Passed.",
						"JP_TC18_Submit_To_IBM_Special_Condition Passed.",test);
//			} else {
//				throw new Exception("Quote status is not correct, actual is " + statusibm);
//			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("JP_TC18_Submit_To_IBM_Special_Condition Failed.",
					"JP_TC18_Submit_To_IBM_Special_Condition.", driver,test);
			driver.quit();
			e.printStackTrace();
