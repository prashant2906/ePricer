...
public class AP_BP_TC07_LP_of_leading_brand_less_than_3_million extends Driver_Setup{
...
//            if (error)
//            {
            	Extent_Reporting.Log_Pass("AP_BP_TC07_LP_of_leading_brand_less_than_3_million Passed.",
    					"AP_BP_TC07_LP_of_leading_brand_less_than_3_million Passed.",test);
//            }
//            else{
...
//            }
			...
			Extent_Reporting.Log_Fail("AP_BP_TC07_LP_of_leading_brand_less_than_3_million Failed.",
					" AP_BP_TC07_LP_of_leading_brand_less_than_3_million.", driver,test);
			driver.quit();
			e.printStackTrace();
