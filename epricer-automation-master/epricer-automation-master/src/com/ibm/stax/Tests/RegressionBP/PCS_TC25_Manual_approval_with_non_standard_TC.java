...
public class PCS_TC25_Manual_approval_with_non_standard_TC extends Driver_Setup {
	...
	@BeforeClass
	public void setUp() {
		System.out.println("PCS_TC25_Manual_approval_with_non_standard_TC");
		driver = getDriver();
	}
	...
	public void PCS_TC25_Manual_approval_with_non_standard_TC_main(String PCSURL, String IBMURL, String ENV)
			throws Throwable {
		...
		try {
			...
			Thread.sleep(5000);
			EpricerApplicationIBMQuoteEditorBusinessLogic.settheNonstandTandC();
			EpricerApplicationIBMQuoteEditorBusinessLogic.approveBPquoteinIBM();
			EpricerApplicationIBMQuoteEditorBusinessLogic.openaddenduminIBM();
			// EpricerApplicationIBMQuoteEditorBusinessLogic.checkexceptiontextinaddendum();

			Extent_Reporting.Log_Pass("PCS_TC25_Manual_approval_with_non_standard_TC Passed.",
					"PCS_TC25_Manual_approval_with_non_standard_TC Passed.",test);

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("PCS_TC25_Manual_approval_with_non_standard_TC Failed.",
					"PCS_TC25_Manual_approval_with_non_standard_TC Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
