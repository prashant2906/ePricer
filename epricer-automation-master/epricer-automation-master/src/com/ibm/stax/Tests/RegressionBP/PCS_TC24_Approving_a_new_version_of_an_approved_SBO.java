...
public class PCS_TC24_Approving_a_new_version_of_an_approved_SBO extends Driver_Setup {
	...
	public void PCS_TC24_Approving_a_new_version_of_an_approved_SBO_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		...
		try {
			...
			EpricerApplicationIBMQuoteEditorBusinessLogic.checkaddendumseleted("Approved addendum 1");
			...
			//EpricerApplicationIBMQuoteEditorBusinessLogic.checkaddendumseleted("Approved addendum 2");
			// open bp to submit the quote again

			Extent_Reporting.Log_Pass("PCS_TC24_Approving_a_new_version_of_an_approved_SBO Passed.",
					"PCS_TC24_Approving_a_new_version_of_an_approved_SBO Passed.", test);

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("PCS_TC24_Approving_a_new_version_of_an_approved_SBO Failed.",
					"PCS_TC24_Approving_a_new_version_of_an_approved_SBO Failed.", driver, test);
			driver.quit();
			e.printStackTrace();
