...
public class AP_BP_TC24_Copra_Priced extends Driver_Setup {
	...
	public void AP_TC24_Copra_Priced_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			createAQuoteBusinessLogic.dataForEPricerAddProductManuallyScreen("5");
...
//
//			if (status.contains("IBM approved")) {
//				Extent_Reporting.Log_Pass("JP_TC24_Copra_Priced Passed.", "JP_TC24_Copra_Priced Passed.");
//			} else {
...
//			}
			 ...
			 * 
			 * PCSEpricerApplicationIBMQuoteEditorBusinessLogic.switchtabunderpricing(
			 * "Prices");
			 * 
			 * PCSEpricerApplicationIBMQuoteEditorBusinessLogic.quickapplyoptimal();
			 * 
			 */

			Thread.sleep(15000);
			Extent_Reporting.Log_Pass("AP_BP_TC24_Copra_Priced Passed.", "AP_BP_TC24_Copra_Priced Passed.",test);
...
//           	{
//            	Extent_Reporting.Log_Pass("AP_BP_TC24_Copra_Priced Passed.",
//    					"AP_BP_TC24_Copra_Priced Passed.");
//           	}
//           	else{
...
//           	}
			...
			Extent_Reporting.Log_Fail("AP_BP_TC24_Copra_Priced Failed.", "AP_BP_TC24_Copra_Priced.", driver,test);
			driver.quit();
			e.printStackTrace();
