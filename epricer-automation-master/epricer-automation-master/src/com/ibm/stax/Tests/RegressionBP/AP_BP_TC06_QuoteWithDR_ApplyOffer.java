...
public class AP_BP_TC06_QuoteWithDR_ApplyOffer extends Driver_Setup{
	...
	public void JP_TC06_QuoteWithDR_ApplyOffer_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
            ...
            //disabled due the offer not avaialble 
       //     createAQuoteBusinessLogic.applyoffer();
              
            createAQuoteBusinessLogic.acceptValueSellerOfferButtonClicked();

			Extent_Reporting.Log_Pass("AP_BP_TC06_QuoteWithDR_ApplyOffer Passed.",
					"AP_BP_TC06_QuoteWithDR_ApplyOffer Passed.",test);
		} catch (Exception e) {
			Extent_Reporting.Log_Fail("AP_BP_TC06_QuoteWithDR_ApplyOffer Failed.",
					"AP_BP_TC06_QuoteWithDR_ApplyOffer Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
