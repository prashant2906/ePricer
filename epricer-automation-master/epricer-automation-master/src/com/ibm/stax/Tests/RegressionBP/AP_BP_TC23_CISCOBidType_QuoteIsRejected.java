...
public class AP_BP_TC23_CISCOBidType_QuoteIsRejected extends Driver_Setup {
	...
	public void JP_CISCOBidType_RejectAQuote_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			Extent_Reporting.Log_Pass("AP_BP_TC23_CISCOBidType_QuoteIsRejected Passed.",
					"AP_BP_TC23_CISCOBidType_QuoteIsRejected Passed.",test);
...
//           	{
//            	Extent_Reporting.Log_Pass("AP_BP_TC23_CISCOBidType_QuoteIsRejected Passed.",
//    					"AP_BP_TC23_CISCOBidType_QuoteIsRejected Passed.");
//           	}
//           	else{
...
//           	}
			...
			Extent_Reporting.Log_Fail("AP_BP_TC23_CISCOBidType_QuoteIsRejected Failed.",
					"AP_BP_TC23_CISCOBidType_QuoteIsRejected.", driver,test);
			driver.quit();
			e.printStackTrace();
