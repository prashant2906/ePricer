...
public class PCS_TC22_IBM_withdraws_a_SBO_quote extends Driver_Setup {
	...
	public void PCS_TC22_IBM_withdraws_a_SBO_quote_main(String PCSURL,String IBMURL,String ENV) throws Throwable {
		...
		try {
			...
			Extent_Reporting.Log_Pass("PCS_TC22_IBM_withdraws_a_SBO_quote Passed.",
					"PCS_TC22_IBM_withdraws_a_SBO_quote Passed.",test);
			
			
		} catch (Exception e) {
			Extent_Reporting.Log_Fail(
					"PCS_TC22_IBM_withdraws_a_SBO_quote Failed.",
					"PCS_TC22_IBM_withdraws_a_SBO_quote Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
