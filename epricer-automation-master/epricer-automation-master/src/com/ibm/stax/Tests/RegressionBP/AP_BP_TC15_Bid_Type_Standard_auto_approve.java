...
public class AP_BP_TC15_Bid_Type_Standard_auto_approve extends Driver_Setup {
	...
	public void JP_TC15_Bid_Type_Standard_auto_approve_main(String MySAURL, String IBMURL, String ENV)
		...
		try {
			...
			Thread.sleep(15000);
			Extent_Reporting.Log_Pass("AP_BP_TC15_Bid_Type_Standard_auto_approve Passed.",
					"AP_BP_TC15_Bid_Type_Standard_auto_approve Passed.",test);
...
//           	{
//        	   Extent_Reporting.Log_Pass("AP_BP_TC15_Bid_Type_Standard_auto_approve Passed.",
//   					"AP_BP_TC15_Bid_Type_Standard_auto_approve Passed.");
//           	}
//           	else{
...
//           
			...
			Extent_Reporting.Log_Fail("AP_BP_TC15_Bid_Type_Standard_auto_approve Failed.",
					"AP_BP_TC15_Bid_Type_Standard_auto_approve Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
