...
public class AP_BP_TC22_Submit_To_IBM_CISCO extends Driver_Setup {
	...
	public void AP_TC22_Submit_To_IBM_CISCO_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
...
//				Extent_Reporting.Log_Pass("JP_TC22_Submit_To_IBM_CISCO Passed.", "JP_TC22_Submit_To_IBM_CISCO Passed.");
//			} else {
...
//			}
			...
			Thread.sleep(15000);
			Extent_Reporting.Log_Pass("AP_BP_TC22_Submit_To_IBM_CISCO Passed.",	"AP_BP_TC22_Submit_To_IBM_CISCO Passed.",test);
...
//           	{
//            	Extent_Reporting.Log_Pass("AP_BP_TC22_Submit_To_IBM_CISCO Passed.",
//    					"AP_BP_TC22_Submit_To_IBM_CISCO Passed.");
//           	}
//           	else{
...
//           	}
			...
			Extent_Reporting.Log_Fail("AP_BP_TC22_Submit_To_IBM_CISCO Failed.", "AP_BP_TC22_Submit_To_IBM_CISCO.",driver,test);
			driver.quit();
			e.printStackTrace();
