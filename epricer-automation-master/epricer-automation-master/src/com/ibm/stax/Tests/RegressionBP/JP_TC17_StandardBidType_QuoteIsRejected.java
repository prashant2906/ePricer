...
public class JP_TC17_StandardBidType_QuoteIsRejected extends Driver_Setup {
	...
	public void JP_StandardBidType_RejectAQuote_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
...
//			if (statusibm.contains("")) {
				Extent_Reporting.Log_Pass("JP_TC17_QuoteIsRejected Passed.", "JP_TC17_QuoteIsRejected Passed.",test);
//			} else {
//				throw new Exception("Quote status is not correct, actual is " + status);
//			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("JP_TC17_QuoteIsRejected Failed.", "JP_TC17_QuoteIsRejected.", driver,test);
			driver.quit();
			e.printStackTrace();
