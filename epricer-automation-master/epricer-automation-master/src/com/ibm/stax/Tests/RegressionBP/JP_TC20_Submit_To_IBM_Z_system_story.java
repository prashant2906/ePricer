...
public class JP_TC20_Submit_To_IBM_Z_system_story extends Driver_Setup {
	...
	Epricer_Application_Create_A_SBO_Quote_Incomplete_It_And_Accept_BusinessLogic createAQuoteIncomAccept = null;
	...
	public void JP_TC20_Submit_To_IBM_Z_system_story_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			createAQuoteIncomAccept = new Epricer_Application_Create_A_SBO_Quote_Incomplete_It_And_Accept_BusinessLogic(driver,TC_ID,test);
...
//			if (statusibm.contains("IBM approved")) {
				Extent_Reporting.Log_Pass("JP_TC20_Submit_To_IBM_Z_system_story Passed.",
						"JP_TC20_Submit_To_IBM_Z_system_story Passed.",test);
//			} else {
//				throw new Exception("Quote status is not correct, actual is " + statusibm);
//			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("JP_TC20_Submit_To_IBM_Z_system_story Failed.",
					"JP_TC20_Submit_To_IBM_Z_system_story.", driver,test);
			driver.quit();
			e.printStackTrace();
