...
public class PCS_TC10_Request_VS_quote_and_distributor_returns extends Driver_Setup {
	...
	@BeforeClass
	public void setUp() {
		System.out.println("PCS_TC10_Request_VS_quote_and_distributor_returns");
		driver = getDriver();
	}
	...
	public void TC10_Request_VS_quote_and_distributor_returns(String PCSURL,String ENV) throws Throwable {
		try {
		...
		//	createAQuoteBusinessLogic.pcsdataForRegistrationNumberScreen();
			...
			Extent_Reporting.Log_Pass("TC10_Request_VS_quote_and_distributor_returns Passed.",
					"TC10_Request_VS_quote_and_distributor_returns Passed.",test);
			
			
		} catch (Exception e) {
			Extent_Reporting.Log_Fail(
					"TC10_Request_VS_quote_and_distributor_returns Failed.",
					"TC10_Request_VS_quote_and_distributor_returns.", driver,test);
			driver.quit();
			e.printStackTrace();
