...
public class JP_TC22_Submit_To_IBM_CISCO extends Driver_Setup {
	...
	public void JP_TC22_Submit_To_IBM_CISCO_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
...
//				Extent_Reporting.Log_Pass("JP_TC22_Submit_To_IBM_CISCO Passed.", "JP_TC22_Submit_To_IBM_CISCO Passed.",test);
//			} else {
...
//			}
			...
			Extent_Reporting.Log_Fail("JP_TC22_Submit_To_IBM_CISCO Failed.", "JP_TC22_Submit_To_IBM_CISCO.", driver,test);
			driver.quit();
			e.printStackTrace();
