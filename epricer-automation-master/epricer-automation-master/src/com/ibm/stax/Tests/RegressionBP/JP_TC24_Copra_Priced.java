...
public class JP_TC24_Copra_Priced extends Driver_Setup{
	...
	public void JP_TC24_Copra_Priced_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
...
//           	{
            	Extent_Reporting.Log_Pass("JP_TC24_Copra_Priced Passed.",
    					"JP_TC24_Copra_Priced Passed.",test);
//           	}
//           	else{
...
//           	}
			...
			PCSEpricerApplicationIBMQuoteEditorBusinessLogic.switchtabunderpricing("Prices");
...
//           	}
			...
			Extent_Reporting.Log_Fail("JP_TC24_Copra_Priced Failed.",
					"JP_TC24_Copra_Priced.", driver,test);
			driver.quit();
			e.printStackTrace();
