...
public class PCS_TC19_Set_quote_as_request_pricing_channel extends Driver_Setup {
	...
	@BeforeClass
	public void setUp() {
		System.out.println("PCS_TC19_Set_quote_as_request_pricing_channel");
		driver = getDriver();
	}
	...
	public void RequestVSQuoteAndDistributorApproves(String PCSURL,String IBMURL,String ENV) throws Throwable {
		try {
			...
			//Login into IBM GUI:
			//PCSNABusinessLogic.sent_to_channel(IBMURL);

			
				
			Extent_Reporting.Log_Pass("PCS_TC19_Set_quote_as_request_pricing_channel Passed.","PCS_TC19_Set_quote_as_request_pricing_channel Passed.",test);
						
			
		} catch (Exception e) {
			Extent_Reporting.Log_Fail("PCS_TC19_Set_quote_as_request_pricing_channel Failed.","PCS_TC19_Set_quote_as_request_pricing_channel Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
