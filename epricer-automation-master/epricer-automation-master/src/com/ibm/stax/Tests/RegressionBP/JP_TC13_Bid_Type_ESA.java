...
public class JP_TC13_Bid_Type_ESA extends Driver_Setup {
	...
	public void JP_TC13_Bid_Type_ESA_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
...
//
//			{
				Extent_Reporting.Log_Pass("JP_TC13_Bid_Type_ESA Passed.", "JP_TC13_Bid_Type_ESA Passed.",test);
//			} else {
//				throw new Exception("Quote status is not correct, actual is " + status);
//			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("JP_TC13_Bid_Type_ESA Failed.", "JP_TC13_Bid_Type_ESA Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
