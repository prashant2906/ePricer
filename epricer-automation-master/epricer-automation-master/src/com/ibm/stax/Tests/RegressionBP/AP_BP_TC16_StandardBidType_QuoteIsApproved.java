...
public class AP_BP_TC16_StandardBidType_QuoteIsApproved extends Driver_Setup {
	...
	public void AP_StandardBidType_ManualApproved_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
...
//				Extent_Reporting.Log_Pass("JP_TC09_CannotAutoApproved Passed.", "JP_TC09_CannotAutoApproved Passed.");
//			} else {
...
//			}
			...
			Thread.sleep(15000);
			Extent_Reporting.Log_Pass("AP_BP_TC16_StandardBidType_QuoteIsApproved Passed.",
					"AP_BP_TC16_StandardBidType_QuoteIsApproved Passed.",test);
...
//           	{
//            	Extent_Reporting.Log_Pass("AP_BP_TC16_StandardBidType_QuoteIsApproved Passed.",
//    					"AP_BP_TC16_StandardBidType_QuoteIsApproved Passed.");
//           	}
//           	else{
//           		throw new Exception("Quote status is not correct, actual is " + status);
//           	}
//			
			...
			Extent_Reporting.Log_Fail("AP_BP_TC16_StandardBidType_QuoteIsApproved Failed.",
					"AP_BP_TC16_StandardBidType_QuoteIsApproved", driver,test);
			driver.quit();
			e.printStackTrace();
