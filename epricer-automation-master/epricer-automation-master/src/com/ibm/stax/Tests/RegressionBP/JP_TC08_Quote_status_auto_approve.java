...
public class JP_TC08_Quote_status_auto_approve extends Driver_Setup{
	...
	public void JP_TC08_Quote_status_auto_approve_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
            ...
            if (!error)
            {
            	Extent_Reporting.Log_Pass("JP_TC08_Quote_status_auto_approve Passed.",
    					"JP_TC08_Quote_status_auto_approve Passed.",test);
            }
            else{
			...
			Extent_Reporting.Log_Fail("JP_TC08_Quote_status_auto_approve Failed.",
					"JP_TC08_Quote_status_auto_approve.", driver,test);
			driver.quit();
			e.printStackTrace();
