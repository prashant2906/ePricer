...
public class JP_TC06_QuoteWithDR_ApplyOffer extends Driver_Setup{
	...
	public void JP_TC06_QuoteWithDR_ApplyOffer_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
       ...
       //     createAQuoteBusinessLogic.applyoffer();
			...
			Extent_Reporting.Log_Pass("JP_TC06_QuoteWithDR_ApplyOffer Passed.",
					"JP_TC06_QuoteWithDR_ApplyOffer Passed.",test);
		} catch (Exception e) {
			Extent_Reporting.Log_Fail("JP_TC06_QuoteWithDR_ApplyOffer Failed.",
					"JP_TC06_QuoteWithDR_ApplyOffer Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
