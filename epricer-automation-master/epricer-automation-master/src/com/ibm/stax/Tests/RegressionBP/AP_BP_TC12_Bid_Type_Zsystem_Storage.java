...
public class AP_BP_TC12_Bid_Type_Zsystem_Storage extends Driver_Setup {
	...
	public void JP_TC12_Bid_Type_Zsystem_Storage_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			Thread.sleep(15000);
			Extent_Reporting.Log_Pass("AP_BP_TC12_Bid_Type_Zsystem_Storage Passed.",
					"AP_BP_TC12_Bid_Type_Zsystem_Storage Passed.",test);
...
//           	{
//        	   Extent_Reporting.Log_Pass("AP_BP_TC12_Bid_Type_Zsystem_Storage Passed.",
//   					"AP_BP_TC12_Bid_Type_Zsystem_Storage Passed.");
//           	}
//           	else{
...
//           
			...
			Extent_Reporting.Log_Fail("AP_BP_TC12_Bid_Type_Zsystem_Storage Failed.",
					"AP_BP_TC12_Bid_Type_Zsystem_Storage.", driver,test);
			driver.quit();
			e.printStackTrace();
