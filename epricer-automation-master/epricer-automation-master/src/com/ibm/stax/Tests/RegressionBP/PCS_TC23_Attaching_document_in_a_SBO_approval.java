...
public class PCS_TC23_Attaching_document_in_a_SBO_approval extends Driver_Setup {
	...
	@BeforeClass
	public void setUp() {
		System.out.println("PCS_TC23_Attaching_document_in_a_SBO_approval");
		driver = getDriver();
	}
	...
	public void PCS_TC23_Attaching_document_in_a_SBO_approval_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		...
		try {
			...
			// EpricerApplicationIBMQuoteEditorBusinessLogic.addattachementonapproveinIBM();
			EpricerApplicationIBMQuoteEditorBusinessLogic.approveBPquoteinIBM();
			// open bp to submit the quote again

			Extent_Reporting.Log_Pass("PCS_TC23_Attaching_document_in_a_SBO_approval Passed.",
					"PCS_TC23_Attaching_document_in_a_SBO_approval Passed.",test);

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("PCS_TC23_Attaching_document_in_a_SBO_approval Failed.",
					"PCS_TC23_Attaching_document_in_a_SBO_approval Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
