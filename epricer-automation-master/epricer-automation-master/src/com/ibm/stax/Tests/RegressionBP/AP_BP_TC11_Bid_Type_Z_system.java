...
public class AP_BP_TC11_Bid_Type_Z_system extends Driver_Setup {
	...
	public void AP_TC11_Bid_Type_Z_system_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			Thread.sleep(15000);
			Extent_Reporting.Log_Pass("AP_BP_TC11_Bid_Type_Z_system Passed.", "AP_BP_TC11_Bid_Type_Z_system Passed.",test);
...
//           	{
//        	   Extent_Reporting.Log_Pass("JP_TC11_Bid_Type_Z_system Passed.",
//   					"JP_TC11_Bid_Type_Z_system Passed.");
//           	}
//           	else{
...
//           	}
			...
			Extent_Reporting.Log_Fail("AP_BP_TC11_Bid_Type_Z_system Failed.", "AP_BP_TC11_Bid_Type_Z_system.", driver,test);
			driver.quit();
			e.printStackTrace();
