...
public class AP_BP_TC17_StandardBidType_QuoteIsRejected extends Driver_Setup{
	...
	public void AP_StandardBidType_RejectAQuote_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
...
//    					"Status is Request pricing Passed.");
//           	}
//           	else{
...
//           	}
			...
			PCSEpricerApplicationIBMQuoteEditorBusinessLogic.approveBPquoteinIBM();
			  ...
			  Thread.sleep(15000);
			  Extent_Reporting.Log_Pass("AP_BP_TC17_StandardBidType_QuoteIsRejected Passed.","AP_BP_TC17_StandardBidType_QuoteIsRejected Passed.",test);
...
//           	{
//            	Extent_Reporting.Log_Pass("AP_BP_TC17_StandardBidType_QuoteIsRejected Passed.",
//    					"AP_BP_TC17_StandardBidType_QuoteIsRejected Passed.");
//           	}
//           	else{
//           		throw new Exception("Quote status is not correct, actual is " + status);
//           	}
...
//			
			...
			Extent_Reporting.Log_Fail("AP_BP_TC17_StandardBidType_QuoteIsRejected Failed.",
					"AP_BP_TC17_StandardBidType_QuoteIsRejected.", driver,test);
			driver.quit();
			e.printStackTrace();
