...
public class JP_TC11_Bid_Type_Z_system extends Driver_Setup{
	...
	public void JP_TC11_Bid_Type_Z_system_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
...
//			if (status.equalsIgnoreCase("Request pricing ")) {
				Extent_Reporting.Log_Pass("JP_TC11_Bid_Type_Z_system Passed.", "JP_TC11_Bid_Type_Z_system Passed.",test);
//			} else {
//				throw new Exception("Quote status is not correct, actual is " + status);
//			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("JP_TC11_Bid_Type_Z_system Failed.", "JP_TC11_Bid_Type_Z_system.", driver,test);
			driver.quit();
			e.printStackTrace();
