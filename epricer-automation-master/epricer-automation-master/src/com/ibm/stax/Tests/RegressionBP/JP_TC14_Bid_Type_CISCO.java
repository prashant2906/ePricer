...
public class JP_TC14_Bid_Type_CISCO extends Driver_Setup {
	...
	public void JP_TC14_Bid_Type_CISCO_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
...
//
//			{
				Extent_Reporting.Log_Pass("JP_TC14_Bid_Type_CISCO Passed.", "JP_TC14_Bid_Type_CISCO Passed.",test);
//			} else {
//				throw new Exception("Quote status is not correct, actual is " + status);
//			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("JP_TC14_Bid_Type_CISCO Failed.", "JP_TC14_Bid_Type_CISCO Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
