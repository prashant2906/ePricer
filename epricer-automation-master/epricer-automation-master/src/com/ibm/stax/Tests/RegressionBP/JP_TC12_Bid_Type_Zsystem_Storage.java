...
public class JP_TC12_Bid_Type_Zsystem_Storage extends Driver_Setup{
...
//        	                            
//           	{
        	   Extent_Reporting.Log_Pass("JP_TC12_Bid_Type_Zsystem_Storage Passed.",
   					"JP_TC12_Bid_Type_Zsystem_Storage Passed.",test);
//           	}
//           	else{
...
//           	}
			...
			Extent_Reporting.Log_Fail("JP_TC12_Bid_Type_Zsystem_Storage Failed.",
					"JP_TC12_Bid_Type_Zsystem_Storage.", driver,test);
			driver.quit();
			e.printStackTrace();
