...
public class AP_BP_TC10_Bid_Type_Special_Condition extends Driver_Setup {
	...
	public void JP_TC10_Bid_Type_Special_Condition_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			Thread.sleep(15000);
			Extent_Reporting.Log_Pass("AP_BP_TC10_Bid_Type_Special_Condition Passed.",
					"AP_BP_TC10_Bid_Type_Special_Condition Passed.",test);
...
//           	{
//            	Extent_Reporting.Log_Pass("AP_BP_TC10_Bid_Type_Special_Condition Passed.",
//    					"AP_BP_TC10_Bid_Type_Special_Condition Passed.");
//           	}
//           	else{
...
//           	}
			...
			Extent_Reporting.Log_Fail("AP_BP_TC10_Bid_Type_Special_Condition Failed.",
					"AP_BP_TC10_Bid_Type_Special_Condition.", driver,test);
			driver.quit();
			e.printStackTrace();
