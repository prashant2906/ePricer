...
public class PCS_TC17_Auto_approved_a_SBO_quote extends Driver_Setup {
	...
	@BeforeClass
	public void setUp() {
		System.out.println("PCS_TC17_Auto_approved_a_SBO_quote");
		driver = getDriver();
	}
	...
	public void PCS_TC17_Auto_approved_a_SBO_quote_method(String PCSURL,String IBMURL,String ENV) throws Throwable {
		try {
			...
			Extent_Reporting.Log_Pass("PCS_TC17_Auto_approved_a_SBO_quote_method Passed.",
					"PCS_TC17_Auto_approved_a_SBO_quote_method Passed.",test);
			
			
		} catch (Exception e) {
			Extent_Reporting.Log_Fail(
					"PCS_TC17_Auto_approved_a_SBO_quote_method Failed.",
					"PCS_TC17_Auto_approved_a_SBO_quote_method Failed.", driver,test);
			driver.quit();
			e.printStackTrace();
