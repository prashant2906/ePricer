...
public class JP_TC19_Submit_To_IBM_Z_system extends Driver_Setup {
	...
	public void JP_TC19_Submit_To_IBM_Z_system_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
...
//			if (statusibm.contains("IBM approved")) {
				Extent_Reporting.Log_Pass("JP_TC19_Submit_To_IBM_Z_system Passed.",
						"JP_TC19_Submit_To_IBM_Z_system Passed.",test);
//			} else {
//				throw new Exception("Quote status is not correct, actual is " + statusibm);
//			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("JP_TC19_Submit_To_IBM_Z_system Failed.", "JP_TC19_Submit_To_IBM_Z_system.",
					driver,test);
			driver.quit();
			e.printStackTrace();
