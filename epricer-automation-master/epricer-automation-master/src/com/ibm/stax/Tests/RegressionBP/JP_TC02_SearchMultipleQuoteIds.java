...
public class JP_TC02_SearchMultipleQuoteIds  extends  Driver_Setup{
	...
	public void Search_Multiple_quotes_For_BPJP(String MySAURL, String IBMURL, String ENV) throws Throwable {
		...
		try {
			...
			Extent_Reporting.Log_Pass("SearchMultipleQuotes","SearchMultipleQuotes Failed.", test);
		}
