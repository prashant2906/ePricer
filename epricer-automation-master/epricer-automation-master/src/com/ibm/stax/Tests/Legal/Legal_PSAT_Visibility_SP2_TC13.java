...
public class Legal_PSAT_Visibility_SP2_TC13 extends Driver_Setup {
	...
	public void Legal_TC10_PSAT_Visibility_SP2_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			Extent_Reporting.Log_Pass("Legal_TC13_PSAT_Visibility_SP2 Passed.",
					"Legal_TC13_PSAT_Visibility_SP2 Passed.", test);
