...
public class Legal_PSAT_Visibility_SP2_TC08 extends Driver_Setup {
	...
	public void Legal_TC08_PSAT_Visibility_SP2_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			EpricerApplicationSearchQuoteBusinessLogic.enterQuoteId(Quoteid_user1);
			...
			if (check1) {
				...
				Extent_Reporting.Log_Pass("Legal_TC08_PSAT_Visibility_SP2 Passed.",
						"Legal_TC08_PSAT_Visibility_SP2 Passed.", test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_TC08_PSAT_Visibility_SP2 Failed.", "Legal_TC08_PSAT_Visibility_SP2.",
					driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
