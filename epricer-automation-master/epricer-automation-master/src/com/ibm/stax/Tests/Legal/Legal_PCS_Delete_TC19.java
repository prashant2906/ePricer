...
public class Legal_PCS_Delete_TC19 extends Driver_Setup{
	...
	public void Legal_PCS_Delete_TC19_main(String PCSURL,String IBMURL, String ENV) throws Throwable {
		try {
			...
			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_S2DEL - SP2 Delete quote");		
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PCS_Delete_TC19 Passed.",
	    					"Legal_PCS_Delete_TC19 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Delete_TC19 Failed.",
					"Legal_PCS_Delete_TC19.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
