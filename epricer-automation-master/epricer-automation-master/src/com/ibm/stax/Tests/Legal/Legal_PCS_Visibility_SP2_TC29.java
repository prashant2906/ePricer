...
public class Legal_PCS_Visibility_SP2_TC29 extends Driver_Setup {
	...
	public void Legal_TC29_PCS_Visibility_SP2_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (errormsg.contains("not authorized")) {
				...
				Extent_Reporting.Log_Pass("Legal_TC29_PCS_Visibility_SP2 Passed.",
						"Legal_TC29_PCS_Visibility_SP2 Passed.", test);
			...
			Extent_Reporting.Log_Fail("Legal_TC29_PCS_Visibility_SP2 Failed.", "Legal_TC29_PCS_Visibility_SP2.", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
