...
public class Legal_IBM_Ongoing_Visibility_TC10 extends Driver_Setup{
	...
	public void Legal_IBM_Ongoing_Visibility_TC10_main(String IBMURL, String ENV) throws Throwable {
		try {
		...
		//	System.out.println(checkIfQuoteExists1 + " " + Quoteidcost );
			...
			{
				Extent_Reporting.Log_Pass("Legal_IBM_Ongoing_Visibility_TC10 Passed.",
    					"Legal_IBM_Ongoing_Visibility_TC10 Passed.", test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Ongoing_Visibility_TC10 Failed.",
					"Legal_IBM_Ongoing_Visibility_TC10 Failed", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
