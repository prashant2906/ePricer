...
public class Legal_PSAT_Delete_TC13 extends Driver_Setup{
		...
		try {
			...
			// login with group EULEG_DSDEL - Dist Delete quote and create quote   UK 
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PSAT_Delete_TC13 Passed.",
	    					"Legal_PSAT_Delete_TC13 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PSAT_Delete_TC13 Failed.",
					"Legal_PSAT_Delete_TC13.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
