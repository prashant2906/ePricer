...
public class Legal_PCS_Visibility_SP2_TC15 extends Driver_Setup {
	...
	public void Legal_TC15_PCS_Visibility_SP2_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_S2HVSP2 - SP2 Hide Value Seller price");
			...
			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_S2VENT - SP2 View Ent price");
			...
			if (checkIfQuoteExists) {
				...
				Extent_Reporting.Log_Pass("Legal_PCS_Visibility_SP2_TC15 Passed.",
						"Legal_PCS_Visibility_SP2_TC15 Passed.", test);
			...
			Extent_Reporting.Log_Fail("Legal_TC15_PCS_Visibility_SP2 Failed.", "Legal_TC15_PCS_Visibility_SP2.", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
