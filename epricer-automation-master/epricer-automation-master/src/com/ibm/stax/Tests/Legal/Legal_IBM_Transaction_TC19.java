...
public class Legal_IBM_Transaction_TC19 extends Driver_Setup {
	...
	public void Legal_IBM_Transaction_TC19_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			//if (checkresult) {
				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC19 Passed.", "Legal_IBM_Transaction_TC19 Passed.",
						test);
			//} else {
			//	throw new Exception("Failed");
			//}
		} catch (Exception e) {
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC19 Failed.", "Legal_IBM_Transaction_TC19 Failed", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
