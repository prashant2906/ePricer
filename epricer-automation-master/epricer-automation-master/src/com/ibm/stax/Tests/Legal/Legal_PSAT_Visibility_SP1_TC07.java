...
public class Legal_PSAT_Visibility_SP1_TC07 extends Driver_Setup {
	...
	public void Legal_TC07_PSAT_Visibility_SP1_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			loginBusinessLogic.LaunchGroupLegal("EULEG_DIHVSP - Dist Hide Value Seller price");
			...
			if (display1) {
				if (!display2) {
					Extent_Reporting.Log_Pass("Legal_TC07_PSAT_Visibility_SP1 Passed.",
							"Legal_TC07_PSAT_Visibility_SP1 Passed.", test);
				}
			...
			Extent_Reporting.Log_Fail("Legal_TC07_PSAT_Visibility_SP1 Failed.", "Legal_TC07_PSAT_Visibility_SP1.",
					driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
