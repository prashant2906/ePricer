...
public class Legal_PSAT_Visibility_SP1_TC03 extends Driver_Setup {
	...
	public void Legal_TC03_PSAT_Visibility_SP1_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			// String Quoteid = "5166792,5166794";
			// String Quoteid_user1 = "5166792";
			// String Quoteid_user2 = "5166794";
			...
			try {
				...
				display1 = driver.findElement(By.linkText(Quoteid_user1)).isDisplayed();

				display2 = driver.findElement(By.linkText(Quoteid_user2)).isDisplayed();

				// display1 = action.isElementPresentByLinkText(Quoteid_user1, driver, test);

				// display2 = action.isElementPresentByLinkText(Quoteid_user2, driver, test);
			...
			if (display1) {
				if (!display2) {
					Extent_Reporting.Log_Pass("Legal_TC03_PSAT_Visibility_SP1 Passed.",
							"Legal_TC03_PSAT_Visibility_SP1 Passed.", test);
				}
			...
			Extent_Reporting.Log_Fail("Legal_TC03_PSAT_Visibility_SP1 Failed.", "Legal_TC03_PSAT_Visibility_SP1.",
					driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
