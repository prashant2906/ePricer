...
public class Legal_IBM_Ongoing_Visibility_TC03 extends Driver_Setup{
	...
	public void Legal_IBM_Ongoing_Visibility_TC03_main(String IBMURL, String ENV) throws Throwable {
		try {
		...
		//	String Quoteid = "5192316";	
			...
			Boolean checkIfQuoteExists = createAQuoteBusinessLogic.checkIfQuoteExists( Quoteid , true);
			
	//		Boolean checkIfQuoteExists = createAQuoteBusinessLogic.checkIfErrorMessageExists( "Some quotes are invalid" , true);
			
			
			if(checkIfQuoteExists)
			{
				Extent_Reporting.Log_Pass("Legal_IBM_Ongoing_Visibility_TC03 Passed.","Legal_IBM_Ongoing_Visibility_TC03 Passed.", test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Ongoing_Visibility_TC03 Failed.","Legal_IBM_Ongoing_Visibility_TC03 Failed", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
