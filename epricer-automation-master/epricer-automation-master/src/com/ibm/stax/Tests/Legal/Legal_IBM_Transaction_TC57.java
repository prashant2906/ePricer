...
public class Legal_IBM_Transaction_TC57 extends Driver_Setup {
	...
	public void Legal_IBM_Transaction_TC57_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			Thread.sleep(2000);
			EpricerApplicationSearchQuoteBusinessLogic.searchCriteriaQuotestatussubcriteria("IBM withdrawn");

			// EpricerApplicationSearchQuoteBusinessLogic.searchCriteriaQuotestatussubcriteriaBPreasoncode(false,"Special
			// bid verification");
			...
			boolean checkresult = EpricerApplicationIBMQuoteEditorBusinessLogic.checkbuttondisplayed("changestatus",true);

			if (checkresult) {

				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC57 Passed.", "Legal_IBM_Transaction_TC57 Passed.",
						test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC57 Failed.", "Legal_IBM_Transaction_TC57 Failed", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
