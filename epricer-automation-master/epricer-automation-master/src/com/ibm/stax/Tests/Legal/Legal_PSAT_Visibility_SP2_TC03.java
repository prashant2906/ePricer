...
public class Legal_PSAT_Visibility_SP2_TC03 extends Driver_Setup {
	...
	public void Legal_TC03_PSAT_Visibility_SP2_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			// String Quoteid = "4190305,4190306";
			// String Quoteid_user1 = "4190305";
			// String Quoteid_user2 = "4190306";
			...
			boolean check2 = EpricerApplicationSearchQuoteBusinessLogic.Checksearchquotedisplay(Quoteid_user2, true);
			System.out.println("check result for user 2 is " + check2);

			if (check1 && check2) {

				Extent_Reporting.Log_Pass("Legal_TC03_PSAT_Visibility_SP2 Passed.",
						"Legal_TC03_PSAT_Visibility_SP2 Passed.", test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_TC03_PSAT_Visibility_SP2 Failed.", "Legal_TC03_PSAT_Visibility_SP2.",
					driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
