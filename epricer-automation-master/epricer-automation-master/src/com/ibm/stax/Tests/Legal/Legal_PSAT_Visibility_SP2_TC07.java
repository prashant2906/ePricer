...
public class Legal_PSAT_Visibility_SP2_TC07 extends Driver_Setup {
	...
	public void Legal_TC04_PSAT_Visibility_SP2_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (check1) {
				...
				Extent_Reporting.Log_Pass("Legal_TC07_PSAT_Visibility_SP2 Passed.",
						"Legal_TC07_PSAT_Visibility_SP2 Passed.", test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_TC07_PSAT_Visibility_SP2 Failed.", "Legal_TC07_PSAT_Visibility_SP2.",
					driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
