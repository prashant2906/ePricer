...
public class Legal_PSAT_Delete_TC03 extends Driver_Setup {
	...
	public void Legal_PSAT_Delete_TC03_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (check2) {
				...
				Extent_Reporting.Log_Pass("Legal_PSAT_Delete_TC03 Passed.", "Legal_PSAT_Delete_TC03 Passed.", test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_PSAT_Delete_TC03 Failed.", "Legal_PSAT_Delete_TC03.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
