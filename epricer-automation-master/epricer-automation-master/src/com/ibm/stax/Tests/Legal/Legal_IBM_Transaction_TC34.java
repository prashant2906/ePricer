...
public class Legal_IBM_Transaction_TC34 extends Driver_Setup {
	...
	public void Legal_IBM_Transaction_TC34_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			boolean checkresult = EpricerApplicationIBMQuoteEditorBusinessLogic.checkbuttondisplayed("approvalhistory",
					false);

			if (checkresult) {

				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC34 Passed.", "Legal_IBM_Transaction_TC34 Passed.",
						test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC34 Failed.", "Legal_IBM_Transaction_TC34 Failed", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
