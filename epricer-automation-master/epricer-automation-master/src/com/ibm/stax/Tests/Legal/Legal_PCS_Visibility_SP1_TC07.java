...
public class Legal_PCS_Visibility_SP1_TC07 extends Driver_Setup {
	...
	public void Legal_TC07_PCS_Visibility_SP1_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			PCSloginBusinessLogic.pcsloggin();PCSloginBusinessLogic.secondIDPageData(ENV);PCSloginBusinessLogic.pcsENVSelect(ENV);
			 
			// select group

			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_DIHVSP - Dist Hide Value Seller price");
			...
			if (checkIfQuoteExists) {
				...
				Extent_Reporting.Log_Pass("Legal_PCS_Visibility_SP1_TC07 Passed.",
						"Legal_PCS_Visibility_SP1_TC07 Passed.", test);
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Visibility_SP1_TC07 Failed.", "Legal_PCS_Visibility_SP1_TC07.", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
