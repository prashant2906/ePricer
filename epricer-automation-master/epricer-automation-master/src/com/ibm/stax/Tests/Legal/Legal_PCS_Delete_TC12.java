...
public class Legal_PCS_Delete_TC12 extends Driver_Setup{
	...
	public void Legal_PCS_Delete_TC12_main(String PCSURL,String IBMURL, String ENV) throws Throwable {
		try {
			...
			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_S2NDEL - SP2 not Delete quote");
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PCS_Delete_TC12 Passed.",
	    					"Legal_PCS_Delete_TC12 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Delete_TC12 Failed.",
					"Legal_PCS_Delete_TC12.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
