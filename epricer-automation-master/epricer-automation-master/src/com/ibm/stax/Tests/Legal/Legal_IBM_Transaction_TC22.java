...
public class Legal_IBM_Transaction_TC22 extends Driver_Setup {
	...
	public void Legal_IBM_Transaction_TC22_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (checkresult) {
				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC22 Passed.", "Legal_IBM_Transaction_TC22 Passed.",
						test);
			} else {
				throw new Exception("Failed");
			}
		} catch (Exception e) {
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC22 Failed.", "Legal_IBM_Transaction_TC22 Failed", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
