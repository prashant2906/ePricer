...
public class Legal_PCS_Visibility_SP2_TC13 extends Driver_Setup {
	...
	public void Legal_TC13_PCS_Visibility_SP2_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			Extent_Reporting.Log_Pass("Legal_TC13_PCS_Visibility_SP2 Passed.", "Legal_TC13_PCS_Visibility_SP2 Passed.",
					test);

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("Legal_TC13_PCS_Visibility_SP2 Failed.", "Legal_TC13_PCS_Visibility_SP2.", driver,
					test);
			driver.quit();
			e.printStackTrace();
