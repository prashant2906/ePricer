...
public class Legal_PCS_Delete_TC06 extends Driver_Setup{
	...
	public void Legal_PCS_Delete_TC06_main(String PCSURL,String IBMURL, String ENV) throws Throwable {
		try {
		...
		//	loginPCSBusinessLogic = new Epricer_Application_PCS_Login_BusinessLogic (driver, TC_ID, test);
			...
			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_S2NDEL - SP2 not Delete quote");
				...
				EpricerApplicationSearchQuoteBusinessLogic.pastsearchCriteriaQuotestatussubcriteria("Returned from distributor");
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PCS_Delete_TC06 Passed.",
	    					"Legal_PCS_Delete_TC06 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Delete_TC06 Failed.",
					"Legal_PCS_Delete_TC06.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
