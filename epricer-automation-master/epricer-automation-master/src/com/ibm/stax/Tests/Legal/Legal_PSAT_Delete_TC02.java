...
public class Legal_PSAT_Delete_TC02 extends Driver_Setup{
	...
	public void Legal_PSAT_Delete_TC02_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			// login with group EULEG_DSDEL - Dist Delete quote and create quote   UK 
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PSAT_Delete_TC02 Passed.",
	    					"Legal_PSAT_Delete_TC02 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PSAT_Delete_TC02 Failed.",
					"Legal_PSAT_Delete_TC02.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
