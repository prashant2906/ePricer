...
public class Legal_PSAT_Visibility_SP1_TC22 extends Driver_Setup{
	...
	public void Legal_TC22_PSAT_Visibility_SP1_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			// login with group EULEG_DSDEL - Dist Delete quote and create quote   UK 
				...
				EpricerApplicationSearchQuoteBusinessLogic.pastsearchCriteriaQuotestatussubcriteria("In Process");
				...
				if (checkIfQuoteExists){
						...
						Extent_Reporting.Log_Pass("Legal_TC22_PSAT_Visibility_SP1 Passed.",
		    					"Legal_TC22_PSAT_Visibility_SP1 Passed.", test);
			...
			Extent_Reporting.Log_Fail("Legal_TC22_PSAT_Visibility_SP1 Failed.",
					"Legal_TC22_PSAT_Visibility_SP1.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
