...
public class Legal_IBM_Transaction_TC55 extends Driver_Setup {
	...
	public void Legal_IBM_Transaction_TC55_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			Thread.sleep(2000);
			EpricerApplicationSearchQuoteBusinessLogic.searchCriteriaQuotestatussubcriteria("IBM approved");
			...
			if (checkresult) {
				...
				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC55 Passed.", "Legal_IBM_Transaction_TC55 Passed.",
						test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC55 Failed.", "Legal_IBM_Transaction_TC55 Failed", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
