...
public class Legal_IBM_Transaction_TC39 extends Driver_Setup {
	...
	public void Legal_IBM_Transaction_TC39_main(String IBMURL, String ENV) throws Throwable {
		try {
		...
		PCSloginBusinessLogic.authenticatePopUpHandle(IBMURL,ENV);
			...
			if (checkresult) {
				...
				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC39 Passed.", "Legal_IBM_Transaction_TC39 Passed.",
						test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC39 Failed.", "Legal_IBM_Transaction_TC39 Failed", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
