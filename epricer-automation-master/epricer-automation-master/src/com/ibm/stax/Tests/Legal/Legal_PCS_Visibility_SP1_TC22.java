...
public class Legal_PCS_Visibility_SP1_TC22 extends Driver_Setup {
	...
	public void Legal_TC22_PCS_Visibility_SP1_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (checkIfQuoteExists) {
				...
				Extent_Reporting.Log_Pass("Legal_TC22_PCS_Visibility_SP1 Passed.",
						"Legal_TC22_PCS_Visibility_SP1 Passed.", test);
			...
			Extent_Reporting.Log_Fail("Legal_TC22_PCS_Visibility_SP1 Failed.", "Legal_TC22_PCS_Visibility_SP1.", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
