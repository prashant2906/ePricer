...
public class Legal_PSAT_Delete_TC18 extends Driver_Setup{
	...
	public void Legal_PSAT_Delete_TC18_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			/*	 
				 String errormsg = EpricerApplicationSearchQuoteBusinessLogic.geterrormassage();
					...
					if (errormsg.contains("not authorized")){
							...
							Extent_Reporting.Log_Pass("Legal_PSAT_Delete_TC18 Passed.",
			    					"Legal_PSAT_Delete_TC18 Passed.", test);
			...
			*/		
			...
			Extent_Reporting.Log_Fail("Legal_PSAT_Delete_TC18 Failed.",
					"Legal_PSAT_Delete_TC18.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
