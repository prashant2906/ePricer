...
public class Legal_PSAT_Delete_TC24 extends Driver_Setup{
	...
	public void Legal_PSAT_Delete_TC24_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			// login with group EULEG_DSDEL - Dist Delete quote and create quote   UK 
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PSAT_Delete_TC24 Passed.",
	    					"Legal_PSAT_Delete_TC24 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PSAT_Delete_TC24 Failed.",
					"Legal_PSAT_Delete_TC24.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
