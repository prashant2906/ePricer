...
public class Legal_IBM_Transaction_TC59 extends Driver_Setup {
	...
	public void Legal_IBM_Transaction_TC59_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			boolean checkresult = EpricerApplicationIBMQuoteEditorBusinessLogic
					.checkdropdwonlistforstatuschange("Incomplete", false);

			if (checkresult) {

				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC59 Passed.", "Legal_IBM_Transaction_TC59 Passed.",
						test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC59 Failed.", "Legal_IBM_Transaction_TC59 Failed", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
