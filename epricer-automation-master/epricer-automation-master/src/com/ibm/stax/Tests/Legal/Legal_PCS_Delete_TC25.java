...
public class Legal_PCS_Delete_TC25 extends Driver_Setup{
	...
	public void Legal_PCS_Delete_TC25_main(String PCSURL,String IBMURL, String ENV) throws Throwable {
		try {
		...
		//	loginPCSBusinessLogic = new Epricer_Application_PCS_Login_BusinessLogic (driver, TC_ID, test);
			...
			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_DSDEL - Dist Delete quote");
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PCS_Delete_TC25 Passed.",
	    					"Legal_PCS_Delete_TC25 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Delete_TC25 Failed.",
					"Legal_PCS_Delete_TC25.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
