...
public class Legal_PSAT_Visibility_SP1_TC05 extends Driver_Setup {
	...
	public void Legal_TC05_PSAT_Visibility_SP1_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			Extent_Reporting.Log_Pass("Legal_TC05_PSAT_Visibility_SP1 Passed.",
					"Legal_TC05_PSAT_Visibility_SP1 Passed.", test);

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("Legal_TC05_PSAT_Visibility_SP1 Failed.", "Legal_TC05_PSAT_Visibility_SP1.",
					driver, test);
			driver.quit();
			e.printStackTrace();
