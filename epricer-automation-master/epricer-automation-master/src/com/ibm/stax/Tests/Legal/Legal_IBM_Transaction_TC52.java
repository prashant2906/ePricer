...
public class Legal_IBM_Transaction_TC52 extends Driver_Setup{
	...
	public void Legal_IBM_Transaction_TC52_main(String IBMURL, String ENV) throws Throwable {
		try {
		...
		*/		
		...
		//	EpricerApplicationSearchQuoteBusinessLogic.selectactioninIBMsearch("Open");
			...
			if(checkresult)
			{
				...
				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC52 Passed.",
    					"Legal_IBM_Transaction_TC52 Passed.", test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC52 Failed.",
					"Legal_IBM_Transaction_TC52 Failed", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
