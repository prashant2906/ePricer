...
public class Legal_IBM_Ongoing_Visibility_TC11 extends Driver_Setup {
	...
	public void Legal_IBM_Ongoing_Visibility_TC11_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			// Boolean checkIfQuoteExists1 = createAQuoteBusinessLogic.checkIfQuoteExists(
			// Quoteidcost , true);
			// System.out.println(checkIfQuoteExists1 + " " + Quoteidcost );

			Boolean checkIfErrorExists = createAQuoteBusinessLogic.checkIfErrorMessageExists("Some quotes are invalid",
					true);

			if (checkIfErrorExists) {
				Extent_Reporting.Log_Pass("Legal_IBM_Ongoing_Visibility_TC11 Passed.",
						"Legal_IBM_Ongoing_Visibility_TC11 Passed.", test);
			} else {
				throw new Exception("Failed");
			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("Legal_IBM_Ongoing_Visibility_TC11 Failed.",
					"Legal_IBM_Ongoing_Visibility_TC11 Failed", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
