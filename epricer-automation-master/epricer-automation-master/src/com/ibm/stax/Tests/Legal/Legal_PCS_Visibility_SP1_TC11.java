...
public class Legal_PCS_Visibility_SP1_TC11 extends Driver_Setup {
	...
	public void Legal_TC11_PCS_Visibility_SP1_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (checkIfQuoteExists) {
				...
				Extent_Reporting.Log_Pass("Legal_PCS_Visibility_SP1_TC11 Passed.",
						"Legal_PCS_Visibility_SP1_TC11 Passed.", test);
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Visibility_SP1_TC11 Failed.", "Legal_PCS_Visibility_SP1_TC11.", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
