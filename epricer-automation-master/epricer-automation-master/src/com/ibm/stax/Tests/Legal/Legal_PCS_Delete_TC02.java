...
public class Legal_PCS_Delete_TC02 extends Driver_Setup {
	...
	public void Legal_PCS_Delete_TC02_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			boolean check2 = EpricerApplicationSearchQuoteBusinessLogic.Checkdropdownlist("Delete", false);
			System.out.println("check result for user 1 is " + check2);

			if (check2) {

				Extent_Reporting.Log_Pass("Legal_PCS_Delete_TC02 Passed.", "Legal_PCS_Delete_TC02 Passed.", test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Delete_TC02 Failed.", "Legal_PCS_Delete_TC02.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
