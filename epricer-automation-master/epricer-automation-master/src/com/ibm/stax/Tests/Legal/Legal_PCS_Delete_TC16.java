...
public class Legal_PCS_Delete_TC16 extends Driver_Setup {
	...
	public void Legal_PCS_Delete_TC16_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (check2) {
				...
				Extent_Reporting.Log_Pass("Legal_PCS_Delete_TC16 Passed.", "Legal_PCS_Delete_TC16 Passed.", test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Delete_TC16 Failed.", "Legal_PCS_Delete_TC16.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
