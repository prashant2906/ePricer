...
public class Legal_PSAT_Visibility_SP2_TC18 extends Driver_Setup {
	...
	public void Legal_TC18_PSAT_Visibility_SP2_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (checkIfQuoteExists1 && checkIfQuoteExists2) {
				Extent_Reporting.Log_Pass("Legal_TC18_PSAT_Visibility_SP2 Passed.",
						"Legal_TC18_PSAT_Visibility_SP2 Passed.", test);
			} else {
				throw new Exception("Failed");
			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("Legal_TC18_PSAT_Visibility_SP2 Failed.", "Legal_TC18_PSAT_Visibility_SP2.",
					driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
