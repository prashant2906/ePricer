...
public class Legal_PSAT_Visibility_SP1_TC13 extends Driver_Setup{
	...
	public void Legal_TC13_PSAT_Visibility_SP1_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
            ...
            // login with group EULEG_DINDEL - Dist not Delete quote   Russia
	    	 loginBusinessLogic.MySALaunch(MySAURL,ENV);
				...
				if (checkIfQuoteExists){
						...
						Extent_Reporting.Log_Pass("Legal_TC13_PSAT_Visibility_SP1 Passed.",
		    					"Legal_TC13_PSAT_Visibility_SP1 Passed.", test);
			...
			Extent_Reporting.Log_Fail("Legal_TC13_PSAT_Visibility_SP1 Failed.",
					"Legal_TC13_PSAT_Visibility_SP1.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
