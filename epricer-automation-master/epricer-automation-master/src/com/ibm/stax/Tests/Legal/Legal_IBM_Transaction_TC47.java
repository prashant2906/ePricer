...
public class Legal_IBM_Transaction_TC47 extends Driver_Setup {
	...
	public void Legal_IBM_Transaction_TC47_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			Thread.sleep(5000);
//			boolean checkresult = EpricerApplicationIBMQuoteEditorBusinessLogic.checkdropdwonlistforstatuschange("IBM withdrawn", true);
//
//			if (checkresult) {
//
				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC47 Passed.", "Legal_IBM_Transaction_TC47 Passed.",
						test);
//			} else {
...
//			}
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC47 Failed.", "Legal_IBM_Transaction_TC47 Failed", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
