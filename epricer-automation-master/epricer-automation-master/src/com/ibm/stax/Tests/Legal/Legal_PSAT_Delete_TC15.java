...
public class Legal_PSAT_Delete_TC15 extends Driver_Setup{
		...
		try {
			...
			// login with group EULEG_DSDEL - Dist Delete quote and create quote   UK 
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PSAT_Delete_TC15 Passed.",
	    					"Legal_PSAT_Delete_TC15 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PSAT_Delete_TC15 Failed.",
					"Legal_PSAT_Delete_TC15.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
