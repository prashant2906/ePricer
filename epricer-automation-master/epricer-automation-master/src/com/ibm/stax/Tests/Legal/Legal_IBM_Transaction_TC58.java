...
public class Legal_IBM_Transaction_TC58 extends Driver_Setup {
	...
	public void Legal_IBM_Transaction_TC58_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			boolean checkresult = EpricerApplicationIBMQuoteEditorBusinessLogic.checkbuttondisplayed("changestatus",
					true);

			if (checkresult) {

				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC58 Passed.", "Legal_IBM_Transaction_TC58 Passed.",
						test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC58 Failed.", "Legal_IBM_Transaction_TC58 Failed", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
