...
public class Legal_PCS_Delete_TC28 extends Driver_Setup{
	...
	public void Legal_PCS_Delete_TC28_main(String PCSURL,String IBMURL, String ENV) throws Throwable {
		try {
			...
			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_DINDEL - Dist not Delete quote");
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PCS_Delete_TC28 Passed.",
	    					"Legal_PCS_Delete_TC28 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Delete_TC28 Failed.",
					"Legal_PCS_Delete_TC28.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
