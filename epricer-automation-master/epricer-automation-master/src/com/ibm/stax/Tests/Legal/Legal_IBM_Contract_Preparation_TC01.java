...
public class Legal_IBM_Contract_Preparation_TC01 extends Driver_Setup {
	...
	public void Legal_IBM_Contract_Preparation_TC01_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			try {
				Displayed = driver.findElement(By.linkText("Prices")).isDisplayed();
			} catch (Exception e) {
				Displayed = false;
			}
			;
			...
			if (Displayed) {
				Extent_Reporting.Log_Pass("Legal_IBM_Contract_Preparation_TC01 Passed.",
						"Legal_IBM_Contract_Preparation_TC01 Passed.", test);
			} else {
				throw new Exception("Failed");
			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("Legal_IBM_Contract_Preparation_TC01 Failed.",
					"Legal_IBM_Contract_Preparation_TC01 Failed", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
