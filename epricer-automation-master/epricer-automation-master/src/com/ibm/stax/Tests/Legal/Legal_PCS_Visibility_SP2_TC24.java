...
public class Legal_PCS_Visibility_SP2_TC24 extends Driver_Setup {
	...
	public void Legal_TC24_PCS_Visibility_SP2_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			EpricerApplicationSearchQuoteBusinessLogic
					.pastsearchCriteriaQuotestatussubcriteria("Returned from distributor");
			...
			if (checkIfQuoteExists) {
				...
				Extent_Reporting.Log_Pass("Legal_TC24_PCS_Visibility_SP2 Passed.",
						"Legal_TC24_PCS_Visibility_SP2 Passed.", test);
			...
			Extent_Reporting.Log_Fail("Legal_TC24_PCS_Visibility_SP2 Failed.", "Legal_TC24_PCS_Visibility_SP2.", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
