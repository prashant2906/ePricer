...
import com.ibm.stax.InitialSetup.Driver_Setup;import org.openqa.selenium.WebDriver;
...
public class Legal_IBM_Transaction_TC49 extends Driver_Setup {
	...
	public void Legal_IBM_Transaction_TC49_main(String IBMURL, String ENV) throws Throwable {
		try {
		...
		PCSloginBusinessLogic.authenticatePopUpHandle(IBMURL,ENV);
			...
			if (checkresult) {
				...
				Extent_Reporting.Log_Pass("Legal_IBM_Transaction_TC49 Passed.", "Legal_IBM_Transaction_TC49 Passed.",
						test);
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Transaction_TC49 Failed.", "Legal_IBM_Transaction_TC49 Failed", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
