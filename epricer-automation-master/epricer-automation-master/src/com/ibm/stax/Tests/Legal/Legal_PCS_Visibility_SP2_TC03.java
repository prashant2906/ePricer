...
public class Legal_PCS_Visibility_SP2_TC03 extends Driver_Setup {
	...
	public void Legal_TC03_PCS_Visibility_SP2_main(String PCSURL, String IBMURL, String ENV) throws Throwable {
		try {
		...
		//	PCSloginBusinessLogic.ibmIDPageData(ENV);
			...
			if (checkIfQuoteExists) {
				...
				Extent_Reporting.Log_Pass("Legal_PCS_Visibility_SP2_TC03 Passed.",
						"Legal_PCS_Visibility_SP2_TC03 Passed.", test);
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Visibility_SP2_TC03 Failed.", "Legal_PCS_Visibility_SP2_TC03.", driver,
					test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
