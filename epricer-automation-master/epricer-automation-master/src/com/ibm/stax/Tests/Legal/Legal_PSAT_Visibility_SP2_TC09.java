...
public class Legal_PSAT_Visibility_SP2_TC09 extends Driver_Setup{
	...
	public void Legal_TC09_PSAT_Visibility_SP2_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			Extent_Reporting.Log_Fail("Legal_TC09_PSAT_Visibility_SP2 Failed.",
					"Legal_TC09_PSAT_Visibility_SP2.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
