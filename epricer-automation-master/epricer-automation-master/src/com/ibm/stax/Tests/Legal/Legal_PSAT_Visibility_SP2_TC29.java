...
public class Legal_PSAT_Visibility_SP2_TC29 extends Driver_Setup{
	...
	public void Legal_TC29_PSAT_Visibility_SP2_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			// login with group EULEG_DSDEL - Dist Delete quote and create quote   UK 
				...
				if (errormsg.contains("not authorized")){
						...
						Extent_Reporting.Log_Pass("Legal_TC29_PSAT_Visibility_SP2 Passed.",
		    					"Legal_TC29_PSAT_Visibility_SP2 Passed.", test);
			...
			Extent_Reporting.Log_Fail("Legal_TC29_PSAT_Visibility_SP2 Failed.",
					"Legal_TC29_PSAT_Visibility_SP2.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
