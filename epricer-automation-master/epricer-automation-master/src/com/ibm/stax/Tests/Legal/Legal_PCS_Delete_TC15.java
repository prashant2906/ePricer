...
public class Legal_PCS_Delete_TC15 extends Driver_Setup{
	...
	public void Legal_PCS_Delete_TC15_main(String PCSURL,String IBMURL, String ENV) throws Throwable {
		try {
			...
			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_DSDEL - Dist Delete quote");		
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PCS_Delete_TC15 Passed.",
	    					"Legal_PCS_Delete_TC15 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Delete_TC15 Failed.",
					"Legal_PCS_Delete_TC15.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
