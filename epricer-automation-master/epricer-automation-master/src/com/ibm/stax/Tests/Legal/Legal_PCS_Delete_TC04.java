...
public class Legal_PCS_Delete_TC04 extends Driver_Setup{
	...
	public void Legal_PCS_Delete_TC04_main(String PCSURL,String IBMURL, String ENV) throws Throwable {
		try {
			...
			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_S2NDEL - SP2 not Delete quote");
				...
				createAQuoteBusinessLogic.myquoterefinebystatus("Prepare for distributor");
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PCS_Delete_TC04 Passed.",
	    					"Legal_PCS_Delete_TC04 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Delete_TC04 Failed.",
					"Legal_PCS_Delete_TC04.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
