...
public class Legal_PSAT_Visibility_SP1_TC18 extends Driver_Setup {
	...
	public void Legal_TC16_PSAT_Visibility_SP1_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (checkIfQuoteExists) {
				...
				if (checkIfQuoteExists) {
					Extent_Reporting.Log_Pass("Legal_TC18_PSAT_Visibility_SP1 Passed.",
							"Legal_TC18_PSAT_Visibility_SP1 Passed.", test);
				}
			} else {
			...
			Extent_Reporting.Log_Fail("Legal_TC18_PSAT_Visibility_SP1 Failed.", "Legal_TC18_PSAT_Visibility_SP1.",
					driver, test);
			driver.quit();
			e.printStackTrace();
