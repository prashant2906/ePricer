...
public class Legal_IBM_Ongoing_TC06 extends Driver_Setup{
	...
	public void Legal_IBM_Ongoing_TC06_main(String IBMURL, String ENV) throws Throwable {
		try {
	...
	//		EpricerApplicationIBMQuoteEditorBusinessLogic.closecurrentIBMquote();
			...
			Thread.sleep(5000);
			Boolean checkQuotestatus = createAQuoteBusinessLogic.checkQuotestatus("Ongoing quote - Rejected");
						
			if(checkQuotestatus)
			{
				Extent_Reporting.Log_Pass("Legal_IBM_Ongoing_TC06 Passed.",
    					"Legal_IBM_Ongoing_TC06 Passed.", test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("Legal_IBM_Ongoing_TC06 Failed.",
					"Legal_IBM_Ongoing_TC06 Failed", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
