...
public class Legal_PCS_Delete_TC18 extends Driver_Setup{
	...
	public void Legal_PCS_Delete_TC18_main(String PCSURL,String IBMURL, String ENV) throws Throwable {
		try {
		...
		//	loginPCSBusinessLogic = new Epricer_Application_PCS_Login_BusinessLogic (driver, TC_ID, test);
			...
			PCSloginBusinessLogic.LaunchGroupLegal("NALEG_S2NDEL - SP2 not Delete quote");
				...
				EpricerApplicationSearchQuoteBusinessLogic.pastsearchCriteriaQuotestatussubcriteria("Submitted to distributor");
				...
				if (check2){
					...
					Extent_Reporting.Log_Pass("Legal_PCS_Delete_TC18 Passed.",
	    					"Legal_PCS_Delete_TC18 Passed.", test);
					}
				else
				{
			...
			Extent_Reporting.Log_Fail("Legal_PCS_Delete_TC18 Failed.",
					"Legal_PCS_Delete_TC18.", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
