...
public class Legal_PSAT_Visibility_SP2_TC10 extends Driver_Setup {
	...
	public void Legal_TC10_PSAT_Visibility_SP2_main(String MySAURL, String IBMURL, String ENV) throws Throwable {
		try {
			...
			createAQuoteBusinessLogic.overviewPolygonScreen();
			createAQuoteBusinessLogic.countrybidtypeselectforEPricerOverviewScreenforlegal("United Kingdom",
					"Managed Services Offering", ENV);
			createAQuoteBusinessLogic.dataForEPricerOverviewScreen();
			...
			checkIfQuoteExists1 = createAQuoteBusinessLogic.checkIfQuoteExists(Quoteid_user1, true);
			System.out.println("check first quote result is " + checkIfQuoteExists1 + " " + Quoteid_user1);
			checkIfQuoteExists2 = createAQuoteBusinessLogic.checkIfQuoteExists(Quoteid_user2, true);
			System.out.println("check second quote result is " + checkIfQuoteExists2 + " " + Quoteid_user2);

			Extent_Reporting.Log_Pass("Legal_TC10_PSAT_Visibility_SP2 Passed.",
					"Legal_TC10_PSAT_Visibility_SP2 Passed.", test);

			if (checkIfQuoteExists1 && checkIfQuoteExists2) {
				Extent_Reporting.Log_Pass("Legal_TC09_PSAT_Visibility_SP2 Passed.",
						"Legal_TC09_PSAT_Visibility_SP2 Passed.", test);
			} else {
				throw new Exception("Failed");
			}

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("Legal_TC10_PSAT_Visibility_SP2 Failed.", "Legal_TC10_PSAT_Visibility_SP2.",
					driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
