...
public class AP_TC9_bid_type_CISCO_and_Approve_IBM extends Driver_Setup{
	...
	@BeforeClass
	public void setUp() {
		System.out.println("AP_TC9_bid_type_CISCO_and_Approve_IBM - BeforeMethod");
		driver = getDriver();
	}

	@Test
	@Parameters({"IBMURL","ENV"})
	public void AP_TC9_bid_type_CISCO_and_ApproveIBM(String IBMURL, String ENV) throws Throwable {
		try {
			...
			{
				Extent_Reporting.Log_Pass("AP_TC9_bid_type_CISCO_and_Approve_IBM Passed.",
    					"AP_TC9_bid_type_CISCO_and_Approve_IBM Passed.",test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("AP_TC9_bid_type_CISCO_and_Approve_IBM Failed.",
					"AP_TC9_bid_type_CISCO_and_Approve_IBM", driver,test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
