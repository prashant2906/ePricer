...
public class JP_TC29_bid_type_CISCO_IBM extends Driver_Setup {
	...
	public void JP_TC29_bid_type_CISCO_IBM_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (quotestatus.equalsIgnoreCase("Contract preparation")) {
				Extent_Reporting.Log_Pass("JP_TC29_bid_type_CISCO_IBM Passed.", "JP_TC29_bid_type_CISCO_IBM Passed.",
						test);
			} else {
			...
			Extent_Reporting.Log_Fail("JP_TC29_bid_type_CISCO_IBM Failed.", "JP_TC29_bid_type_CISCO_IBM", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
