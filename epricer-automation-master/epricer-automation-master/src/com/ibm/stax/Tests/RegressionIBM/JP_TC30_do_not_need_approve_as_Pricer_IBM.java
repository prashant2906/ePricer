...
public class JP_TC30_do_not_need_approve_as_Pricer_IBM extends Driver_Setup{
	...
	public void JP_TC30_do_not_need_approve_as_Pricer_IBM_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			{
				Extent_Reporting.Log_Pass("JP_TC30_do_not_need_approve_as_Pricer_IBM Passed.",
    					"JP_TC30_do_not_need_approve_as_Pricer_IBM Passed.", test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("JP_TC30_do_not_need_approve_as_Pricer_IBM Failed.",
					"JP_TC30_do_not_need_approve_as_Pricer_IBM", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
