...
public class AP_TC5_Bid_Type_CISCO_IBM extends Driver_Setup{
	...
	@BeforeClass
	public void setUp() {
		System.out.println("inside class : AP_TC5_Bid_Type_CISCO_IBM- BeforeMethod");
		driver = getDriver();
	}

	@Test
	@Parameters({"IBMURL","ENV"})
	public void AP_TC5_BidType_CISCO_IBM(String IBMURL, String ENV) throws Throwable {
		try {
			...
			{
				Extent_Reporting.Log_Pass("AP_TC5_Bid_Type_CISCO_IBM Passed.",
    					"AP_TC5_Bid_Type_CISCO_IBM Passed.",test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("AP_TC5_Bid_Type_CISCO_IBM Failed.",
					"AP_TC5_Bid_Type_CISCO_IBM", driver,test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
