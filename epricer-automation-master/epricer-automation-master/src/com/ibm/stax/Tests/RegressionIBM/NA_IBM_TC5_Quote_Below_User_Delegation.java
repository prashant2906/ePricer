...
public class NA_IBM_TC5_Quote_Below_User_Delegation extends Driver_Setup{
	...
	@BeforeClass
	public void setUp(){
		System.out.println("inside class : NA_IBM_TC5_Quote_Below_User_Delegation- BeforeMethod");
		driver=getDriver();
	}
	...
	public void createAndApproveQuote(String IBMURL,String ENV) throws Throwable{		
		try{
			...
			Extent_Reporting.Log_Pass("NA_IBM_TC5_Quote_Below_User_Delegation Passed.","NA_IBM_TC5_Quote_Below_User_Delegation Passed.",test);
		}
		 catch (Exception e) {
				Extent_Reporting.Log_Fail(
						"NA_IBM_TC5_Quote_Below_User_Delegation Failed.",
						"NA_IBM_TC5_Quote_Below_User_Delegation Failed.", driver,test);
				driver.quit();
				e.printStackTrace();
