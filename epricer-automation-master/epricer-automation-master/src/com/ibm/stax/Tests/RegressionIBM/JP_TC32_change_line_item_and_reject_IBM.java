...
public class JP_TC32_change_line_item_and_reject_IBM extends Driver_Setup{
	...
	public void JP_TC32_change_line_item_and_reject_IBM_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			{
				Extent_Reporting.Log_Pass("JP_TC32_change_line_item_and_reject_IBM Passed.",
    					"JP_TC32_change_line_item_and_reject_IBM Passed.", test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("JP_TC32_change_line_item_and_reject_IBM Failed.",
					"JP_TC32_change_line_item_and_reject_IBM Failed", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
