...
public class AP_TC3_Change_BottomLine_Need_Approve_IBM extends Driver_Setup{
	...
	@BeforeClass
	public void setUp() {
		System.out.println("AP_TC3_Change_BottomLine_Need_Approve_IBM - BeforeMethod");
		driver = getDriver();
	}

	@Test
	@Parameters({"IBMURL","ENV"})
	public void AP_TC3_Change_BottomLine_Need_ApproveIBM(String IBMURL, String ENV) throws Throwable {
		try {
			...
			if(quotestatus.equalsIgnoreCase("Ongoing quote - Need approval"))
			{
				Extent_Reporting.Log_Pass("AP_TC3_Change_BottomLine_Need_Approve_IBM Passed.",
    					"AP_TC3_Change_BottomLine_Need_Approve_IBM Passed.",test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("AP_TC3_Change_BottomLine_Need_Approve_IBM Failed.",
					"AP_TC3_Change_BottomLine_Need_Approve_IBM Failed", driver,test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
