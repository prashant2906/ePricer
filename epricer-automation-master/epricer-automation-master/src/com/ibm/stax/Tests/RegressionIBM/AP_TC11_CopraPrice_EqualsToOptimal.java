...
public class AP_TC11_CopraPrice_EqualsToOptimal extends Driver_Setup {
	...
	@BeforeClass
	public void setUp() {
		System.out.println("AP_TC11_CopraPrice_EqualsToOptimal - BeforeMethod");
		driver = getDriver();
	}

	@Test
	@Parameters({ "IBMURL", "ENV", })
	public void CopraPrice_EqualsToOptimal(String IBMURL, String ENV) throws Throwable {
		try {
			...
			Extent_Reporting.Log_Pass("AP_TC11_CopraPrice_EqualsToOptimal Failed.",
					"AP_TC11_CopraPrice_EqualsToOptimal", test);

		} catch (Exception e) {
			Extent_Reporting.Log_Fail("AP_TC11_CopraPrice_EqualsToOptimal Failed.",
					"AP_TC11_CopraPrice_EqualsToOptimal", driver, test);
			driver.quit();
			e.printStackTrace();
