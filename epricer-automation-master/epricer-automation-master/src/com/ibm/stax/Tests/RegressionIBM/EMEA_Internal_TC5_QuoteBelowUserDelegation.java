...
public class EMEA_Internal_TC5_QuoteBelowUserDelegation extends Driver_Setup{
	...
	@BeforeClass
	public void setUp(){
		System.out.println("inside class : EMEA_Internal_TC5_QuoteBelowUserDelegation- BeforeMethod");
		driver=getDriver();
	}
	...
	public void createAndApproveQuote(String IBMURL,String ENV,String Timestamp) throws Throwable{		
		try{
			...
			Extent_Reporting.Log_Pass("EMEA_Internal_TC5_QuoteBelowUserDelegation Passed.",
					"EMEA_Internal_TC5_QuoteBelowUserDelegation Passed.", test);
		}
		 catch (Exception e) {
				Extent_Reporting.Log_Fail(
						"EMEA_Internal_TC5_QuoteBelowUserDelegation Failed.",
						"EMEA_Internal_TC5_QuoteBelowUserDelegation Failed.", driver, test);
