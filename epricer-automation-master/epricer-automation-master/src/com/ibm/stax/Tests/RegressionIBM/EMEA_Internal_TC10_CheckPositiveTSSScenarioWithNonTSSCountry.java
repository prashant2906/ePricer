...
public class EMEA_Internal_TC10_CheckPositiveTSSScenarioWithNonTSSCountry extends Driver_Setup{
	...
	@BeforeClass
	public void setUp(){
		System.out.println("inside class : EMEA_Internal_TC10_CheckPositiveTSSScenarioWithNonTSSCountry- BeforeMethod");
		driver=getDriver();
	}
	
	@Test
	@Parameters({"IBMURL","ENV","Timestamp"})
	public void CheckPositiveTSSScenarioWithNonTSSCountry(String IBMURL,String ENV,String Timestamp) throws Throwable{		
		try{
			...
			Extent_Reporting.Log_Pass("EMEA_Internal_TC10_CheckPositiveTSSScenarioWithNonTSSCountry Passed.",
					"EMEA_Internal_TC10_CheckPositiveTSSScenarioWithNonTSSCountry Passed.", test);
		}
		 catch (Exception e) {
				Extent_Reporting.Log_Fail("EMEA_Internal_TC10_CheckPositiveTSSScenarioWithNonTSSCountry Failed.",
						"EMEA_Internal_TC10_CheckPositiveTSSScenarioWithNonTSSCountry Failed.", driver, test);
