...
public class JP_TC28_change_line_item_need_approve_IBM extends Driver_Setup{
	...
	public void JP_TC28_change_line_item_need_approve_IBM_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			{
				Extent_Reporting.Log_Pass("JP_TC28_change_line_item_need_approve_IBM Passed.",
    					"JP_TC28_change_line_item_need_approve_IBM Passed.", test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("JP_TC28_change_line_item_need_approve_IBM Failed.",
					"JP_TC28_change_line_item_need_approve_IBM Failed", driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
