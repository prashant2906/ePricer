...
public class JP_TC26_do_not_need_approve_IBM extends Driver_Setup {
	...
	public void JP_TC26_do_not_need_approve_IBM_main(String IBMURL, String ENV) throws Throwable {
		try {
			...
			if (quotestatus.equalsIgnoreCase("Contract preparation")) {
				Extent_Reporting.Log_Pass("JP_TC26_do_not_need_approve_IBM Passed.",
						"JP_TC26_do_not_need_approve_IBM Passed.", test);
			} else {
			...
			Extent_Reporting.Log_Fail("JP_TC26_do_not_need_approve_IBM Failed.", "JP_TC26_do_not_need_approve_IBM",
					driver, test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
