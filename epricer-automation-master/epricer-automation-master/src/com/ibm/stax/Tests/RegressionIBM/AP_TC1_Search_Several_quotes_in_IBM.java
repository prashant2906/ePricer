...
public class AP_TC1_Search_Several_quotes_in_IBM extends Driver_Setup{
	...
	@BeforeClass
	public void setUp() {
		System.out.println("AP_TC1_Search_Several_quotes_in_IBM - BeforeMethod");
		driver = getDriver();
	}

	@Test
	@Parameters({"IBMURL","ENV"})
	public void AP_TC1_Search_Several_quotes_inIBM(String IBMURL, String ENV) throws Throwable {
		try {
			...
			String quoteid11 = action.getInputTextValue(driver, ".//*[@id='currentquotetab']/li[1]/div/div[1]", "first result");
			System.out.println(quoteid11);
			String quoteid12 = action.getInputTextValue(driver, ".//*[@id='currentquotetab']/li[2]/div/div[1]", "first result");
			System.out.println(quoteid12);
			
			if (Quoteid.contains(quoteid11)){
				if (Quoteid.contains(quoteid12)){
					Extent_Reporting.Log_Pass("AP_TC1_Search_Several_quotes_in_IBM Passed.",
	    					"AP_TC1_Search_Several_quotes_in_IBM Passed.",test);
				}				
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("AP_TC1_Search_Several_quotes_in_IBM Failed.",
					"AP_TC1_Search_Several_quotes_in_IBM", driver,test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
