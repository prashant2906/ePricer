...
public class AP_TC4_Change_Line_Item_Need_Approve_IBM extends Driver_Setup{
	...
	public void AP_TC4_Change_Line_Item_Need_ApproveIBM(String IBMURL, String ENV) throws Throwable {
		try {
			...
			{
				Extent_Reporting.Log_Pass("AP_TC4_Change_Line_Item_Need_Approve_IBM Passed.",
    					"AP_TC4_Change_Line_Item_Need_Approve_IBM Passed.",test);
			}
			else
			{
			...
			Extent_Reporting.Log_Fail("AP_TC4_Change_Line_Item_Need_Approve_IBM Failed.",
					"AP_TC4_Change_Line_Item_Need_Approve_IBM Failed", driver,test);
			driver.quit();
			e.printStackTrace();
			throw new Exception("Failed");
		}
